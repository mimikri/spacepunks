...
class FleetFunctions 
{
	...
	public static function GetFleetMaxSpeed ($Fleets, array $Player)
	{
		if(empty($Fleets)) {
			return 0;
		}
	...
	public static function GetFleetConsumption($FleetArray, $MissionDuration, $MissionDistance, array $Player, $GameSpeed): float
	{
		$consumption = 0;
