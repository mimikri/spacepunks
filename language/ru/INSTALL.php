...
$LNG['intro_welcome']         = 'Добро пожаловать в spacepunks!';
$LNG['intro_text']            = 'spacepunks - один из лучших клонов OGame.<br>spacepunks является самым стабильным и развивающимся движком из всех подобных XNova на данный момент. Мы надеемся, что spacepunks будет лучше, чем Вы ожидаете.<br><br>Если у Вас будут вопросы, консультируйтесь с нами.<br><br>spacepunks является проектом с открытым кодом и распространяется под лицензией GNU GPL v3, ознакомиться с которой Вы можете в разделе Лицензия.<br><br>Перед установкой будет запущен небольшой тест на соответствие минимальным требованиям.';
$LNG['intro_upgrade_head']    = 'spacepunks уже установлена';
$LNG['intro_upgrade_text']    = '<p>Вы уже установили spacepunks и просто хотите её обновить?</p><p>Здесь вы можете обновить старую базу данных с помощью нескольких кликов.</p>';
...
$LNG['upgrade_required_rev']  = 'Мастер обновления базы данных доступен с ревизии r2579 (spacepunks v1.7).';
...
$LNG['req_desc']              = 'Перед продолжением установки spacepunks выполнит проверку файлов конфигурации Вашего сервера на соответствие необходимым требованиям использования spacepunks. Пожалуйста, прочитайте внимательно результаты и не продолжайте установку, пока проверка не будет пройдена по всем пунктам. Если Вы хотите использовать любую из функций перечисленных ниже модулей, Вы должны убедиться, что проверка пройдена.';
$LNG['reg_yes']               = 'Да';
$LNG['reg_no']                = 'Нет';
$LNG['reg_found']             = 'Да';
...
$LNG['req_php_need_desc']     = '<strong>Требование</strong> — PHP является серверным языком, на котором написана игра. spacepunks работает без ограничений, используя версию PHP 5.2.5 и выше.';
...
$LNG['reg_global_desc']       = 'spacepunks будет корректно работать, если этот параметр включён. Тем не менее, рекомендуется по соображениям безопасности, отключить register_globals в настройках PHP.';
...
$LNG['req_ftp_dir']           = 'FTP путь к spacepunks';
...
$LNG['step3_desc']            = 'Таблицы базы данных созданы и заполнены. Переходите к следующему шагу, чтобы завершить установку spacepunks.';
...
$LNG['step6_desc']            = 'Вы установили spacepunks.';
$LNG['step6_info_head']       = 'Начните использовать spacepunks.';
...
$LNG['sql_welcome']           = 'Добро пожаловать в spacepunks v';