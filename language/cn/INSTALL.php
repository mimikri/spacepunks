...
$LNG['intro_welcome']			= '您好，spacepunks的用户！';
$LNG['intro_text']				= '您正在安装的spacepunks，是OGame类项目中最好的实现之一。<br>spacepunks是也当前仍在开发的XNova中最新最稳定的版本。spacepunks的卓越之处在于其稳定、灵活、开发活跃、高质量以及被千锤百炼。我们总是希望着这部作品能够超乎你所期盼。<br><br>本安装系统将会引导你安装，或者从上个版本升级。对于使用本系统中的每一个困惑，以及发生的每一个问题，请不要犹豫，立即向开发及技术支持人员提出！<br><br>spacepunks是一个开放源代码的工程，基于GNU GPL v3授权。如对此还有疑异，可以点击下方的链接查看"Lincense"<br><br>在安装开始前，会有一个小测试，用来检测您的空间的方案/域名是否能完全满足spacepunks的需要';
$LNG['intro_upgrade_head']		= '已经安装过spacepunks？';
$LNG['intro_upgrade_text']		= '<p>您已经安装过spacepunks，然后想轻松升级到当前版本？</p><p>您只需点击几下就能完成数据库的更新！</p>';
...
$LNG['upgrade_required_rev']	= '更新器只能够用于r2579 (spacepunks v1.7)以及更高版本。';


$LNG['licence_head']			= '许可条款';
$LNG['licence_desc']			= '请阅读以下许可条款。拖动滚动条以阅读该文档的全部内容';
$LNG['licence_accept']			= '我接受此协议的条款'; //（在安装spacepunks前，您必须同意spacepunks的许可条款）
$LNG['licence_need_accept']		= '若要继续安装，您必须接受此协议中的条款';

$LNG['req_head']				= '系统需求';
$LNG['req_desc']				= '在安装开始前，spacepunks会做个测试，检验您的服务器是否能支持spacepunks，以保证spacepunks能够正常安装。建议您仔细阅读测试结果，如果检测中有未通过的项目，请勿继续安装。';
$LNG['reg_yes']					= '是';
$LNG['reg_no']					= '否';
$LNG['reg_found']				= '已找到';
...
$LNG['req_php_need_desc']		= '<strong>必须</strong> — spacepunks基于PHP. 而且需要PHP版本高于5.2.5，这样才能使所有的模块正常工作';
...
$LNG['reg_global_desc']			= '即使您的服务器已经配置开启"register_globals"，spacepunks也能正常工作，但出于安全考虑，还是建议尽可能地去禁用掉改选项。';
$LNG['req_ftp_head']			= '请填写FTP账户信息';
$LNG['req_ftp_desc']			= '填写您的FTP信息，以便spacepunks能够自动修复权限相关的问题。或者您也可以手动去修改目录的写入权限。';
$LNG['req_ftp_host']			= '服务器名';
$LNG['req_ftp_username']		= '用户名';
$LNG['req_ftp_password']		= '密码';
$LNG['req_ftp_dir']				= 'spacepunks安装目录';
$LNG['req_ftp_send']			= '发送';
$LNG['req_ftp_error_data']		= '无法连接到FTP，您提供的信息有误，因此该环节失败！';
$LNG['req_ftp_error_dir']		= '您所填写的目录不存在！';

$LNG['step1_head']				= '配置数据库信息';
$LNG['step1_desc']				= '现在，已经确定了您的服务器可以安装spacepunks，接着，您要提供一些数据库相关的信息。如果您不知道如何连接数据库，请先与您的服务提供商联系，或者去spacepunks官方论坛寻求帮助。当你填写完相关的信息，系统会先检查是否有误，然后会建表和插入初始数据。';
...
$LNG['step3_desc']				= 'spacepunks所需的数据表已经创建成功，并且已经导入了默认值。点击下一步，结束spacepunks的安装';
...
$LNG['step6_head']				= '安装完成！';
$LNG['step6_desc']				= '您已经成功安装spacepunks';
$LNG['step6_info_head']			= '立即开始spacepunks！';
...
$LNG['sql_welcome']				= '欢迎来到spacepunks v';
