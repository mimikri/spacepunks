...
$LNG['intro_welcome']			= 'Hosgeldin yeni spacepunks Kullanicisi!';
$LNG['intro_text']				= 'spacepunks en iyi ogame projelerinden birisidir.<br>spacepunks mevcut gelistirilmis en yeni ve guvenilir Xnova versiyonudur. spacepunks gerek kullanim kolayligi, gerek kod esnekligi, dinamizmi, kod kalitesi ve islevleri ile goz almaktadir. Her zaman sizin beklentilerinizden daha iyi olmaya calistik. <br><br> Kurulumdaki direktifler kurulum esnasinda size rehberlik edecektir. Her sorun ve problemde, bize danismak icin kesinlikle tereddut etmeyin!<br><br>The spacepunks bir acik kod uygulamasidir ve GNU GPL v3 lisanslidir. Lisans hakkinda bilgi edinmek icin asagidaki "Lisans" linkine tiklayabilirsiniz.  <br><br> Kurulum islemine baslamadan once sisteminiz spacepunks kurmak icin gerekli ozelliklere sahip olup olmadigi test edilecektir. ';
$LNG['intro_upgrade_head']		= 'Sisteminizde spacepunks mevcut kurulu mu?';
$LNG['intro_upgrade_text']		= '<p>Sisteminizde spacepunks kurulu, kolay bir guncelleme istermisiniz?</p><p>Buraya tiklayarak sisteminizin eski veritabanini bir kac tiklama ile guncelleyebilirsiniz.!</p>';
...
$LNG['upgrade_required_rev']	= 'Guncelleme programi versiyon  r2579 (spacepunks v1. 7) yada ust versiyonlari icin uygulanabilir.';


$LNG['licence_head']			= 'Lisans Kosullari';
$LNG['licence_desc']			= 'Lutfen asagidaki lisans kosullarini iyice okuyunuz.';
$LNG['licence_accept']			= 'spacepunks kurulumuna devam etmek icin, lisans sartlarini kabul etmeniz gerekmektedir. ';
...
$LNG['req_desc']				= 'Kuruluma baslamadan once spacepunks sistemin kurulum icin uygun olup olmadigini test edecek. Sonuclari dikkatlice okumaniz tavsiye edilir ve butun testleri gecmeden bir sonraki adima gecmeyiniz';
$LNG['reg_yes']					= 'Evet';
$LNG['reg_no']					= 'Hayir';
...
$LNG['req_php_need_desc']		= '<strong>Gereken:</strong> — PHP spacepunks yazilim dilidir. Bu sebeple, butun fonksiyonlarin tam calisabilmesi icin mevcut PHP versiyonu 5.2.5 yada ustu olmasi gereklidir. ';
...
$LNG['reg_global_desc']			= 'spacepunks globaller aktif olsun olsun olmasin calisacaktir. Ama, eger mumkunse guvenlik onlemleri bunu inaktif yapmaniz onerilir.';
$LNG['req_ftp_head']			= 'FTP bilgilerini giriniz';
$LNG['req_ftp_desc']			= 'FTP bilgilerinizi giriniz ve spacepunks otomatik olarak problemleri duzeltsin. Alternatif olarak, kendiniz yetki verebilirsiniz.';
$LNG['req_ftp_host']			= 'Domain Adi(HostName)';
$LNG['req_ftp_username']		= 'Kullanici Adi';
$LNG['req_ftp_password']		= 'Sifre';
$LNG['req_ftp_dir']				= 'spacepunks klasoru';
...
$LNG['step1_desc']				= 'spacepunks sisteminize kurululabilir. Simdi, veritabanina baglanmak icin asagidaki bilgileri girmelisiniz. Eger gerekli bilgileri bilmiyorsaniz, domain (alan) saglayiciniz ile irtibata geciniz yada spacepunks forumlarindaki direktifleri okuyunuz.';
...
$LNG['step3_desc']				= 'spacepunks veritabani icin mevcut tablolar yaratildi ve varsayilan degerler yuklendi. Bir sonraki isleme gecip kurulumu tamamlamak icin;';
...
$LNG['step6_desc']				= 'spacepunks sisteminize basari ile kuruldu';
$LNG['step6_info_head']			= 'spacepunks kullanilmaya hazir!';
$LNG['step6_info_additional']	= 'Asagidaki butona tiklayarak spacepunks admin sayfasina yonlendirileceksiniz. spacepunks admin araclarini buradan inceleyebilirsiniz.<br/><br/><strong> &raquo;includes/ENABLE_INSTALL_TOOL&laquo; dosyasini silmeyi unutmayiniz. Eger bu dosya sisteminizde kalirsa baska birisinin oyunu tekrar kurmasina izin vererek kurulumunuzu buyuk riske atarsiniz!</strong>';

$LNG['sql_close_reason']		= 'Oyun su an kapali';
$LNG['sql_welcome']				= 'spacepunks\'a hosgeldiniz';
