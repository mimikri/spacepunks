...
$LNG['intro_welcome']			= 'Serdecznie witamy w spacepunks!';
$LNG['intro_text']				= 'spacepunks to najlepszy klon Ogame.<br>spacepunks to najnowsza i najbardziej stabilna wersja Xnova, jaka kiedykolwiek powstała. Cechuje ją przyjazność, elastyczność i dynamiczność, jak również najwyższa jakość obsługi. System przeprowadzi Cię przez proces instalacji lub też aktualizacji aktualnej wersji do najnowszej. Jeśli masz jakiekolwiek problemy nie wahaj się zadać pytania na naszym forum poświęconemu rozwojowi i wsparciu.<br><br>spacepunks podlega licencji GNU GPL v3. Licencje przeczytasz po kliknięciu odpowiedniego linku w menu.<br><br>Przed instalacją skrypt sprawdzi, czy twój serwer spełnia minimalne wymagania.';
$LNG['intro_upgrade_head']		= 'Zainstalować spacepunks?';
$LNG['intro_upgrade_text']		= '<p>spacepunks zainstalowane, chcesz teraz sprawdzić aktualizacje?</p><p>Aktualizacje!</p>';
...
$LNG['upgrade_required_rev']	= 'Aktualizator bazy danych działa od wersji r2579 (spacepunks v1.7) lub wyższej!.';
...
$LNG['req_desc']				= 'spacepunks sprawdzi teraz konfigurację twojego serwera. Czytaj uważnie wyniki testów nim przejdziesz dalej. Jeśli chcesz używać opcjonalnych modułów to upewnij się że dodatkowe testy mają wynik pozytywny..';
$LNG['reg_yes']					= 'Tak';
$LNG['reg_no']					= 'Nie';
...
$LNG['req_php_need_desc']		= '<strong>Wymagane</strong> — PHP to język skryptowy wykonywane po stronie serwera, spacepunks jest w nim napisany. Do poprawnej instalacji wymagana wersja minimalna to PHP Version 5.2.5.';
$LNG['reg_gd_need']				= 'Zainstalowana wersja biblioteki graficznej &raquo;gdlib&laquo;';
$LNG['reg_gd_desc']				= '<strong>Opcjonalne</strong> — Biblioteka graficzna &raquo;gdlib&laquo; jest potrzebna do generowania grafik w "locie". Bez niej nie wykorzystasz wszystkich możliwości spacepunks.';
...
$LNG['reg_global_desc']			= 'spacepunks nie będzie funkcjonował gdy register_globals jest aktywne. Z powodów bezpieczeństwa zaleca się by, register_globals wyłączyć w ustawieniach php.';
$LNG['req_ftp_head']			= 'Dostęp do FTP';
$LNG['req_ftp_desc']			= 'Tutaj podaj dane dostępowe do serwera FTP, dzięki temu spacepunks będzie mogło się automatycznie aktualizować. Alternatywnym sposobem jest robienie tego ręcznie.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'Nazwa użytkownika';
$LNG['req_ftp_password']		= 'Hasło';
$LNG['req_ftp_dir']				= 'Ścieżka do katalogu w którym jest zainstalowane spacepunks';
...
$LNG['step6_desc']				= 'Zainstalowałeś prawidłowo spacepunks.';
...
$LNG['sql_welcome']				= 'Serdecznie witamy na spacepunks v';
