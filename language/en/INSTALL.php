...
$LNG['intro_welcome']			= 'Hello user of spacepunks!';
$LNG['intro_text']				= 'The spacepunks is one of the best projects of OGame.<br>The spacepunks is the newest and most stable of XNova currently developed. spacepunks is remarkable for its ease of stability, flexibility, dynamism, quality and utilization. we always expect to be better than your expectations.<br><br>The installation system will guide you through the installation or upgrading from a previous version to the latest one. Each question, a problem, please dont hesitate to ask our development and support in case of doubt!<br><br>The spacepunks is an Open Source project, licensed under the GNU GPL v3. For this to be verified, please click the link above where it refers to "lincense"<br><br>Before the installation can be started a small test to see if your plan/domain has all the requirements to support the spacepunks';
$LNG['intro_upgrade_head']		= 'spacepunks already installed?';
$LNG['intro_upgrade_text']		= '<p>You have already installed spacepunks and want easy updating?</p><p>Here you can update your old database with just a few clicks!</p>';
...
$LNG['upgrade_required_rev']	= 'The Updater can work only from revision r2579 (spacepunks v1. 7) or later.';
...
$LNG['licence_accept']			= 'To continue the installation of spacepunks, you need to agree to the terms and conditions of lincense of spacepunks';
...
$LNG['req_desc']				= 'Before the installation proceed, spacepunks will be some tests to verify that your server supports the spacepunks, so ensure that the spacepunks can be installed. Its suggested that you read carefully the results, and do not proceed until all these be checked.';
$LNG['reg_yes']					= 'Yes';
$LNG['reg_no']					= 'No';
$LNG['reg_found']				= 'Found';
...
$LNG['req_php_need_desc']		= '<strong>Required</strong> — PHP is the language code base of spacepunks. This is the required PHP version 5.2.5 or higher so that all modules work correctly';
...
$LNG['reg_global_desc']			= 'spacepunks will also work, if this configuration is installed on your server. However, it is recommended for security reasons, disable "register_globals" in PHP installation, if that is possible.';
$LNG['req_ftp_head']			= 'Insert information of FTP';
$LNG['req_ftp_desc']			= 'Write your information from FTP so spacepunks automatically fix problems. Alternatively, you can also manually assign permissions to write.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'User name';
$LNG['req_ftp_password']		= 'Password';
$LNG['req_ftp_dir']				= 'Directory of spacepunks';
...
$LNG['step3_desc']				= 'The tables needed for the spacepunks database already have been created and populated with default values. To go to the next step, conclude the installation of spacepunks';
